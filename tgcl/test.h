...
public:
    explicit Test_file(const std::string &path, TdClass *td_client) : path_(path), td_client_(td_client) {}
...
public:
    explicit Test_table(const size_t table_size, TdClass *td_client) : table_size_(table_size), td_client_(td_client) {
    }
