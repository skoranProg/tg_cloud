...
tgfs_db::tgfs_db(const std::string &path) {
    ...
    //              nullptr);
    sqlite3_exec(table_, "PRAGMA synchronous=FULL;", nullptr, nullptr, nullptr);
